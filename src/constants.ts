...
export const INITIAL_ITEMS: ProposalItem[] = [
  ...
  { id: 39, desc: "Contagem de Pessoas", type: "mensal", unit: "SERVIÇO", unitPrice: 0.00, quantity: 0 },
  { id: 40, desc: "Detecção de Intrusão", type: "mensal", unit: "SERVIÇO", unitPrice: 0.00, quantity: 0 },
  { id: 41, desc: "Detecção de Aglomeração", type: "mensal", unit: "SERVIÇO", unitPrice: 0.00, quantity: 0 },
  { id: 21, desc: "Licença Adicional Hórus", type: "mensal", unit: "SERVIÇO", unitPrice: 490.00, quantity: 0 },
  { id: 37, desc: "Integração LPR (envio de imagens)", type: "mensal", unit: "SERVIÇO", unitPrice: 199.90, quantity: 0 },
  ...
  { id: 38, desc: "Integração LPR c/ órgãos Gov", type: "unico", unit: "SERVIÇO", unitPrice: 10000.00, quantity: 0 },
